...
from strategy import CodexDirectAskStrategy  # noqa: E402


async def main() -> None:
    parser = build_arg_parser("Run the direct-model PPBench private50 baseline.")
    args = parser.parse_args()
    output_dir = Path(__file__).resolve().parent / "results"
    summary = await run_private50_baseline(
        strategy_factory=CodexDirectAskStrategy,
        strategy_name="direct_model",
